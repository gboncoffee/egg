...
func TestIsa(t *testing.T) {
	...
	_ = m.LoadProgram(code)

	// add t0, t1, t2
	_ = m.SetRegister(1+8, 3)
	_ = m.SetRegister(2+8, 2)
	...
	// addiu t0, t1, 3
	_ = m.SetRegister(1+8, 0xf0_00_00_00)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0xf0000003 {
	...
	// addu t0, t1, t2
	_ = m.SetRegister(1+8, 3)
	_ = m.SetRegister(2+8, 0xf0_00_00_00)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0xf0000003 {
	...
	// subu t0, t1, t2
	_ = m.SetRegister(1+8, 0x80_00_00_03)
	_ = m.SetRegister(2+8, 2)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0x80_00_00_01 {
	...
	// sra t0, t1, 2
	_ = m.SetRegister(1+8, 0x80_00_00_00)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0xe0_00_00_00 {
	...
	// and t0, t1, t2
	_ = m.SetRegister(1+8, 0xffff)
	_ = m.SetRegister(2+8, 0xff)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0xff {
	...
	// nor t0, t1, t2
	_ = m.SetRegister(1+8, 0xff_ff_00_00)
	_ = m.SetRegister(2+8, 0x00_ff_ff_00)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0x00_00_00_ff {
	...
	// movn t0, t1, t2
	_ = m.SetRegister(0+8, 0)
	_ = m.SetRegister(1+8, 0xff)
	_ = m.SetRegister(2+8, 0)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0 {
	...
	// mthi t0
	_ = m.SetRegister(1+8, 0x12345678)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(HI)
	if v != 0x12345678 {
	...
	// bltz t0, 8
	_ = m.SetRegister(0+8, 0xff_ff_ff_ff)
	savedPC = m.pc
	_, _ = m.NextInstruction()
	if m.pc != 0 {
	...
	// syscall
	_ = m.SetRegister(2, machine.SYS_READ)
	_ = m.SetRegister(4, 1)
	_ = m.SetRegister(5, 2)
	call, _ = m.NextInstruction()
	...
	// jalr t0
	_ = m.SetRegister(0+8, 0x12345678)
	savedPC = m.pc
	_, _ = m.NextInstruction()
	if m.pc != 0x12345678 {
	...
	// lb t0, t1, 0
	_ = m.SetMemoryChunk(0xcafebabe, []uint8{0xff, 2, 3, 4})
	_ = m.SetRegister(1+8, 0xcafebabe)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0xff_ff_ff_ff {
	...
	// lh t0, t1, 0
	_ = m.SetMemoryChunk(0xcafebabe, []uint8{0xff, 0xff, 3, 4})
	_ = m.SetRegister(1+8, 0xcafebabe)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0xff_ff_ff_ff {
	...
	// lw t0, t1, 0
	_ = m.SetMemoryChunk(0xcafebabe, []uint8{1, 2, 3, 4})
	_ = m.SetRegister(1+8, 0xcafebabe)
	_, _ = m.NextInstruction()
	v, _ = m.GetRegister(0 + 8)
	if v != 0x04_03_02_01 {
	...
	// sb t0, t1, 0
	_ = m.SetMemoryChunk(0xcafebabe, []uint8{0, 0, 0, 0})
	_ = m.SetRegister(0+8, 0xdeadbeef)
	_ = m.SetRegister(1+8, 0xcafebabe)
	_, _ = m.NextInstruction()
